...
boxplot(Assessment ~ factor(Time), data = Exa8.4.1)
Exa8.4.1_lm <- lm(Assessment ~ factor(Time), data = Exa8.4.1)
Anova(Exa8.4.1_lm)
#
emmeans(Exa8.4.1_lm, pairwise ~ factor(Time))
emmeans(Exa8.4.1_lm, trt.vs.ctrl ~ factor(Time))
```
