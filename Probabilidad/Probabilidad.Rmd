...
**Respuesta** Este es una grupo de 318 sujetos (muestra) y de la muestra completa de 18 o menores son 141 (como menores y 18 es excluyente de mayores de 18), la probabilidad es numero de sujetos en (debut Temprano)/total de sujetos de la muestra
$$ P(E) =141/318 = 0.4434 $$  
...
Algunas veces se quiere estimar la probabilidad de escojer a un sujeto de una muestra pero que tenga dos características de la muestra (se no son mutuamente excluyentes) y es el caso de la *probabilidad conjunta*  
...
**Ejemplo** Si seleccionamos de forma aleatoria de los 318 sujetos de la **Tabla 1**, cual es la probabilidad de que esta persona pertenezca al grupo de debut temprano de Trastornos Afectivos $(E)$ o pertensca al grupo de familia sin historial de Trastornos Afectivos $(A)$ o ambos?  
