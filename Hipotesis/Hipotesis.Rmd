...
*Respuesta* Si la cirugía incrementa la función biliar, esto es incrementa GBEL, $\mu_{cirugia} > \mu_0$, es decir queremos demostrar que la diferencia en GBEL es positiva. Por lo tanto, la hipótesis nula es que $H_0: \mu_{diferencia} \leq 0$ y por lo tanto $H_A: \mu_{diferencia} > 0$
