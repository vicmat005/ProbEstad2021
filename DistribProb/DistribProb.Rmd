...
en la ecuación anterior $\pi$ y $e$ son los múneros irracionales iguales a $3.141516 \dots$ y $2.71828 \dots$.  Los dos parámetros de la distribución son $\mu$, el promedio y $\sigma$ la desviación estándar.  
...
Es la distribución que esta cnetrada al cero $\mu = 0$ y con desviación estándar igual a 1, $\sigma = 1$, creando la variabla aleatoria estandarizada    
...
**ejemplo** cuan es la probabilidad de que z tomado al azar esté entre $-2.55$ y $2.55$   
*respuesta* estamos canculando la probabilidad de $P(-2.55 < z < 2.55) = P(X \leq 2.55) - P(X \leq -2.55)$  
```{r}
