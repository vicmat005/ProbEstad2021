...
3. No es drasticamente influenciada por los valores extremos, como lo es el promedio.  
...
Una distribución se puede clasificar si es simétrica o asimétrica. Se dice que si el histograma de una distribución no es simétrico la distribución esta *sesgada* (skewed) si la tendencia de las barras del histograma está cargada a la derecha se dice que está sesgada positivamente y si es para la izquierda se dice que está sesgada negativamente.  

$$ Skewness = \frac{\sqrt{n}\sum_{i=1}^{n}(x_i - \bar{x})^3}{(n-1)\sqrt{n-1}s^3} $$
