...
## Rango  
Una forma de hablar de la dispersión de datos es dar el rango de los valores que toma toda la muestra y si el valor mínimo los es $x_L$ y el máximo del los valores es $X_M$ el rango $R$ se estima cómo  
...
$$ Q_1 = \frac{n+1}{4} observaciones ordenadas $$

$$ Q_2 = \frac{2(n+1)}{4} = \frac{n+1}{2} observaciones ordenadas $$
$$ Q_3 = \frac{3(n+1)}{4} observaciones ordenadas $$
